...
class Vision:
    ...
    def Face_Detect():
        ...
        classifier=cv2.CascadeClassifier(r"C:\Users\Simon\Desktop\12Ucpt\opencvdata\data\haarcascades/haarcascade_frontalface_alt.xml")
    ...
    def face_calibration():
        ...
        classifier = \
            cv2.CascadeClassifier(r"C:\Users\Simon\Desktop\12Ucpt\opencvdata\data\haarcascades/haarcascade_frontalface_alt.xml"
                                  )
    ...
    def get_mid_point(nearest, fearest):
        mid_point = (nearest+fearest)/2
        return mid_point
    
    def range_swich(mid_point,h):
        swich = False
        if h >= mid_point:
            swich = True
        else:
